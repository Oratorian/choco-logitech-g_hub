...
$url        = 'https://download01.logi.com/web/ftp/pub/techsupport/gaming/lghub_installer.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'Logitech G HUB' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
